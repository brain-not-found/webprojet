...
<form method="POST" >
    <br><br><br><br>
                        <table class="tablexx">
    <tr><td>identifiant</td></p><td><input type="text" name="identifiant" required id="identifiant"></td></tr>
    <tr><td>produit</td><td><input type="text" name="produit" required id="produit"></td></tr>
    <tr><td>quantite</td></p><td><input type="text" name="quantite"required id="quantite"></td></tr>
    <tr><td>adresse</td><td><input type="text" name="adresse" id="adresse"></td></tr>
  </table>
  <label class="validerxx" class="valider3x"><input type="submit" name="button" value="ajouter" class="validerxx" href="ajouterr.php"></label>
