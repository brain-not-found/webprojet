<?php 
//index.php
$connect = mysqli_connect("localhost", "root", "root", "livraison");
$query = "SELECT * FROM livreur";
$result = mysqli_query($connect, $query);
$chart_data = '';
while($row = mysqli_fetch_array($result))
{
 $chart_data .= "{ cin:'".$row["cin"]."', salaire:".$row["salaire"]."}, ";
}
...
<body class="theme-red">
  ...
  <div class="container" style="width:900px;">
   ...
   <h3 align="center" style="color:rgb(44, 172, 171)">des livreur selon leurs salaires  </h3>   
   <br /><br />
   <div id="chart"></div>
  </div>
