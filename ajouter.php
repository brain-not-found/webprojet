...
<form method="POST"  >
    <br><br><br><br>
                         <table class="tablexx">
    <tr><td>Matricule</td></p><td><input type="text" name="matricule" required=""></td></tr>
    <te><td>marque</td><td><input type="text" name="marque" required=""></td></tr>
    <tr><td>chauffeur</td></p><td><input type="text" name="chauffeur" required=""></td></tr>
    <te><td>livraison</td><td><input type="text" name="livraison" required=""></td></tr>
  </table>
  <label class="validerxx" class="valider3x"><input type="submit" name="button" value="ajouter" class="validerxx" href="ajouter.php"></label>
